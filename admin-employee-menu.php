    ...
    <div style="display: flex; justify-content: center; align-items: center; gap: 4rem;">
        ...
        <div style="display: flex; flex-direction: column; gap: 2rem; align-items: center;">
            <div style="display: flex; align-items: center; gap: 1rem;">
                <a href="admin-employee-profiles.php" class="custom-btn">EMPLOYEE PROFILES</a>
                <img src="admin-dashboard-employee-profiles.png" alt="Employee Profiles" class="icon">
            </div>
            <div style="display: flex; align-items: center; gap: 1rem;">
                <a href="admin-employee-logs.php" class="custom-btn">TASK LOGS</a>
                <img src="admin-dashboard-activity-logs.png" alt="Activity Logs" class="icon">
            </div>
        </div>
    </div>
</main>
