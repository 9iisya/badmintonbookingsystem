    ...
    <div style="display: flex; justify-content: center; align-items: center; gap: 4rem;">
        ...
        <div style="display: flex; flex-direction: column; gap: 2rem; align-items: center;">
            <div style="display: flex; align-items: center; gap: 1rem;">
                <a href="admin-report-weekly.php" class="custom-btn">WEEKLY REPORT</a>
                <img src="admin-report-menu-weekly.png" alt="Customer Profiles" class="icon">
            </div>
            <div style="display: flex; align-items: center; gap: 1rem;">
                <a href="admin-report-monthly.php" class="custom-btn">MONTHLY REPORT</a>
                <img src="admin-report-menu-montly.png" alt="Booking History" class="icon">
            </div>
        </div>
    </div>
</main>
